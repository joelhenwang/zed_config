 ...
 */
export declare function getNodeIfIsInComponentStartTag(html: HTMLDocument, document: Document, offset: number): Node | undefined;
/**
 ...
 */
export declare function getNodeIfIsInTagName(html: HTMLDocument, offset: number): Node | undefined;
/**
...
export declare function toRange(str: Document, start: number, end: number): Range;
/**
...
export declare function inStyleOrScript(document: Document, position: Position): boolean;
